---
title: Kennu | Pentest Blog
---

<div class="terminal-intro">
<span class="prompt">kennu@kali</span><span class="output">:</span><span class="path">~$</span> whoami<br>
<span class="output">Kennu - Graduate Cybersecurity Consultant @ BDO</span><br>
<span class="prompt">kennu@kali</span><span class="output">:</span><span class="path">~$</span> cat goals.txt<br>
<span class="output">Working towards HTB CPTS</span><br>
<span class="prompt">kennu@kali</span><span class="output">:</span><span class="path">~$</span> <span class="cursor blink">_</span>
</div>

<!-- Add specialisation later
<span class="prompt">kennu@kali</span><span class="output">:</span><span class="path">~$</span> cat focus.txt<br>
<span class="output">[Your specialization, e.g. "Web app security · Active Directory · Linux privesc"]</span><br>
-->
